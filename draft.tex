...
\item[\textsc{pop9}]We have $t' = t$ and $t \in fs[s']$.
\item[\textsc{ret-pop}] $t'$ is obtained by applying \textsc{ret-pop} rule of $AbsS$ and $t' \in fs[s']$.
\end{itemize}
\end{proof}
