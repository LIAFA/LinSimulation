...
{\footnotesize
  ...
  \begin{mathpar}
    \inferrule[call-push]{
      ...
      O,<,\ell,rval,cp,comp,pend 
      \xrightarrow{inv(push,d,k)} \\
      O\cup\{k\},<\cup \{(k',k): \ell_2(k')={\tt COMP}\},\ell[k\mapsto (d,{\tt PEND},\emptyset)],rval,cp[k\mapsto 1],comp,pend[\forall k'.\ k'\mapsto pend(k')\cup \{k\}]
    }\hspace{5mm}
    ...
    \inferrule[call-pop]{
      ...
      O,<,\ell,rval,cp[k\mapsto 1],comp[k\mapsto maxCompl(<)],pend[k\mapsto \{k':\ell_2(k')={\tt PEND}\}]
    }\hspace{5mm}
    ...
    \inferrule[ret-pop]{
      ...
      O,<,\ell,rval,cp[k\mapsto 3],comp,pend
    }\hspace{5mm}
    ...
    \inferrule[ret-push1]{
      ...
      O,<,\ell[k\mapsto (d,{\tt COMP},X)],rval,cp[k\mapsto 2],comp,pend
    }\hspace{5mm}
    ...
    \inferrule[ret-push2]{
      ...
      O,<,\ell,rval,cp,comp,pend
      \xrightarrow{ret(push,k)}
      O,<,\ell,rval,cp[k\mapsto 2],comp,pend
    }\hspace{5mm}

    \inferrule[lin-pop1]{
       cp(k) = 1 \\
       d\neq{\tt EMPTY} \\
       \exists k'\in O.\ k'\in comp(k)\cup pend(k)\land \ell_1(k')=d
    }{
      O,<,\ell,rval,cp,comp,pend
      \xrightarrow{lin(pop,d,k)} \\
      O\setminus \{k\},<\uparrow k,\ell,rval[k\mapsto d],cp[k\mapsto 2],comp[\forall k''.\ k'\in comp(k'') \Rightarrow k'' \mapsto (comp(k'')\cup pred_{<}(k'))\setminus\{k'\}],pend
    }\hspace{5mm}
    ...
    \inferrule[lin-deq2]{
      ...
      O,<,\ell,rval[k\mapsto {\tt EMPTY}],cp[k\mapsto 2],comp,pend
    }\hspace{5mm}
