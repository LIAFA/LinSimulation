...
%		& \mathsf{Operations}, \mathsf{Values} : \mathsf{Sort} \\
		& \text{\underline{Abstract State}} \\
		& \text{{\ttfamily \bfseries function}}\ \mathsf{present} : \<Ops> \rightarrow \mathbb{B} \\
		& \text{{\ttfamily \bfseries function}}\ \mathsf{pending} : \<Ops> \rightarrow \mathbb{B} \\
		& \text{{\ttfamily \bfseries function}}\ \mathsf{arg} : \<Ops> \rightarrow \<Vals> \\
		& \text{{\ttfamily \bfseries function}}\ \mathsf{before} : \<Ops> \times \<Ops> \rightarrow \mathbb{B} \\
