...
<<<<<<< HEAD
    ...
    while,do,if,then,else,assume,assert,proc,call,return,rule,forall,with,new,choose,skip,%
=======
    var,const,bool,int,true,false,void,atomic,new,%
    while,do,if,then,else,assume,assert,proc,call,return,%
>>>>>>> 8f73a5f25e21b88306a4d772c4c77008fe826307
...
\proglangkeyword{%
  var, const, bool, int, void, for, atomic,rulem
